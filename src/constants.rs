...
pub const ACTIVE_PERP_MARKETS: usize = 11;
pub const UNUSED_PERP_MARKETS: usize = 14;
pub const ACCOUNT_NAME_MAX_LEN: usize = 10;
pub const MAX_CROSS_MARGIN_ACCOUNTS: usize = 25;
